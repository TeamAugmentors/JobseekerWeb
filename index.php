        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-6 col-sm-12 hero-text-col">
                ...
                <div class="hero-buttons">
                    <a class="btn shadow-none btn-primary-custom rounded-btn"
                        href="https://drive.google.com/u/0/uc?id=1eegNBg5l8NAVdHD5DzRxe_HYoSNoReoy&export=download"
                        target="_blank">Get
                        the app<i class="fas fa-arrow-down"></i></a>
                    <a class="btn shadow-none btn-secondary rounded-btn"
                        href="https://www.youtube.com/watch?v=YYKiquIiLZ4&t=193s" target="_blank">Watch
